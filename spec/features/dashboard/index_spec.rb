...
RSpec.describe 'merchant dashboard' do
  before :each do
    ...
    @item_3 = Item.create!(name: "Brush", description: "This takes out tangles", unit_price: 20, merchant_id: @merchant1.id)
    @item_4 = Item.create!(name: "Hair tie", description: "This holds up your hair", unit_price: 1, merchant_id: @merchant1.id)
    @item_5 = Item.create!(name: "Hair clippers", description: "This shaves your head", unit_price: 100, merchant_id: @merchant1.id)
    @item_6 = Item.create!(name: "Almers Glue", description: "This holds up your mohawk", unit_price: 5, merchant_id: @merchant1.id)

    # Note: customer ranking => customer6 110, customer5 100, customer2 40, customer3 20, customer1 10, customer4 1 (6, 5, 2, 3, 1, 4)
    @ii_1 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_1.id, quantity: 1, unit_price: 10, status: 0)
    @ii_2 = InvoiceItem.create!(invoice_id: @invoice_2.id, item_id: @item_2.id, quantity: 5, unit_price: 8, status: 0)
    @ii_3 = InvoiceItem.create!(invoice_id: @invoice_3.id, item_id: @item_3.id, quantity: 1, unit_price: 20, status: 2)
    @ii_4 = InvoiceItem.create!(invoice_id: @invoice_4.id, item_id: @item_4.id, quantity: 1, unit_price: 1, status: 1)
    @ii_5 = InvoiceItem.create!(invoice_id: @invoice_5.id, item_id: @item_5.id, quantity: 1, unit_price: 100, status: 1)
    @ii_6 = InvoiceItem.create!(invoice_id: @invoice_6.id, item_id: @item_6.id, quantity: 2, unit_price: 5, status: 1)
    @ii_7 = InvoiceItem.create!(invoice_id: @invoice_6.id, item_id: @item_5.id, quantity: 1, unit_price: 100, status: 1)
    ...
    @transaction5_2 = Transaction.create!(credit_card_number: 102938, result: 1, invoice_id: @invoice_5.id)
    @transaction6 = Transaction.create!(credit_card_number: 879799, result: 1, invoice_id: @invoice_6.id)
    @transaction7 = Transaction.create!(credit_card_number: 203942, result: 1, invoice_id: @invoice_6.id)
